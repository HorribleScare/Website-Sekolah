...
if($msg == 'LULUS'){
	...
	<i class="fa-solid fa-circle-check"></i> SELAMAT.. siswa dengan NIS : ' . $nis . '
...
if($msg == 'GAGAL'){
	...
	<i class="fa-solid fa-circle-xmark"></i> Siswa dengan NIS : ' . $nis . '
	GAGAL UJIAN
	<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
				...
				<div class="col-8">
					<div class="card">
						<div class="card-header">
							...
							<button type="reset" name="reset" class="btn btn-sm btn-danger float-end me-1">
