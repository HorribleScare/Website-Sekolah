			...
			<h1 class="mt-4">Siswa</h1>
				...
				<div class="card">
					<div class="card-header">
						...
						<i class="fa-solid fa-plus"></i> Tambah Siswa</a>
					</div>
						...
						<table class="table table-hover" id="datatablesSimple">
							...
							<tbody>
								...
								<tr>
									...
									class="rounded-circle" alt="foto siswa" width="60px"></td>
									<td><?= $data['nis'] ?></td>
									<td><?= $data['nama'] ?></td>
									<td><?= $data['kelas'] ?></td>
									<td><?= $data['jurusan'] ?></td>
									<td><?= $data['alamat'] ?></td>
									<td align="center">
										<a href="edit-siswa.php?nis=<?= $data['nis'] ?>" class="btn btn-sm btn-warning" title="Update Siswa">
