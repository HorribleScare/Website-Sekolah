			...
			<h1 class="mt-4">Guru</h1>
				...
				<div class="card">
					<div class="card-header">
						...
						<i class="fa-solid fa-plus"></i> Tambah Guru</a>
					</div>
						...
						<table class="table table-hover" id="datatablesSimple">
							...
							?>
								<tr>
									...
									<td><?= $data['alamat'] ?></td>
									<td align="center">
										<a href="edit-guru.php?id=<?= $data['id'] ?>" class="btn btn-sm btn-warning" title="update guru">
										<i class="fa-solid fa-pen"></i></a>
										
										<button type="button" class="btn btn-sm btn-danger" id="btnHapus" title="hapus guru"
										data-id="<?= $data['id'] ?>" data-foto="<?= $data['foto'] ?>">
