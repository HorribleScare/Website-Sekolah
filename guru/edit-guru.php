						...
						<input type="hidden" name="id" value="<?= $data['id'] ?>">
							<div class="mb-3 row">
								...
								<div class="col-sm-9" style="margin-left: -50px;">
									...
									title="minimal 18 angka" class="form-control ps-2 border-0 border-bottom"
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9" style="margin-left: -50px;">
									<input type="tel" name="telpon" pattern="[0-9]{5,}"
									title="minimal 5 angka" class="form-control ps-2 border-0 border-bottom"
