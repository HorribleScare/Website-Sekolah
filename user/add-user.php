			...
			?>
				...
				<div class="card">
					<div class="card-header">
						...
						<button type="submit" name="simpan" class="btn btn-primary float-end"><i class="fa-solid fa-floppy-disk"></i>
						Simpan</button>
						...
						<div class="row">
							<div class="col-8">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9" style="margin-left: -50px;">
										<input type="text"
										class="form-control border-0 border-bottom" id="nama" name="nama"
										maxlength="20" required>
									</div>
								</div>
